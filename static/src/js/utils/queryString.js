 ...
 * @author Søren Beier Husted <sni@dis-play.dk>
 */
 ...
 * @param {String} url - The url to get and set query string. Defaults to current window location
 */
export function addParameter(key, value, override = true, url = window.location.href) {
 ...
 * @param {String} url -The url to get and set query string. Defaults to current window location
 */
export function deleteParameter(key, value = false, url = window.location.href) {
