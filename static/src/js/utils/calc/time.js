...
/**
 *
 * @param {Number} fromTimestamp - A timestamp in milliseconds
 * @param {Number} toTimestamp - A timestamp in milliseconds
 ...
 */
export function timeDifference(fromTimestamp, toTimestamp) {
    let difference = Math.abs(fromTimestamp - toTimestamp);
