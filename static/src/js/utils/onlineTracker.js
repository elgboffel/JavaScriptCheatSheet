...
const classNameOnline = "dis-online";
const classNameOffline = "dis-offline";
const onlineMethods = [];
...
function setNavigatorState () {
    ...
    if (navigatorState !== navigator.onLine && typeof navigator.onLine === "boolean") {
